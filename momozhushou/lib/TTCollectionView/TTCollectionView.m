...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UILabel *title=[[UILabel alloc] initWithFrame:CGRectMake(0, self.frame.size.height-21, kScreenWidth, 21)];
    title.text=self.titleArr[indexPath.item];
...
- (void)setImagesCount:(NSInteger)imagesCount {
    ...
    // page控制
    self.page = [[UIPageControl alloc] initWithFrame:CGRectMake(kScreenWidth - 90, CGRectGetMaxY(self.frame) - 30, 100, 20)];
