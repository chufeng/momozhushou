//
//  hotAnimationViewController.swift
//  momozhushou
//
...
class hotAnimationViewController: UIViewController {
    ...
    func loadData(){
        ...
        let url=NSString.init(format:"http://api.aimengniang.com/post/listcount?is_check=20009&limit=10&page=%d",page)
        print(url)
...
extension hotAnimationViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        selectvc.navigationController?.isNavigationBarHidden=false
        selectvc.model2=tbArray[(indexPath as NSIndexPath).section]as!TBmodel
        self.navigationController?.pushViewController(selectvc, animated: true)
    }
}
extension hotAnimationViewController:animateCellDelegate{
